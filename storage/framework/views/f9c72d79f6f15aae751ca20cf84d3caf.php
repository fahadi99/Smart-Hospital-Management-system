                        ...
                        <thead class="text-gray-500 fs-7 text-uppercase">
                            <tr role="row" class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <th class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom"
                                    ...
                                    tabindex="0"><span class="dt-column-title" role="button">Department</span><span
                                ...
                                <th class="min-w-90px dt-orderable-asc dt-orderable-desc" data-dt-column="2" rowspan="1"
                                    colspan="1" aria-label="Status: Activate to sort" tabindex="0"><span
                                        ...
                                        class="dt-column-order"></span></th>
                                <th class="min-w-50px text-end dt-orderable-none" data-dt-column="3" rowspan="1"
                            ...
                            <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <td>
                                    <div class="d-flex flex-column justify-content-center">
                                        <a href="" class="mb-1 text-gray-800 text-hover-primary"><?php echo e($d->name); ?></a>
                                    </div>
                                </td>
                                <td data-order="<?php echo e($d->created_at); ?>"><?php echo e(getBasicDateTimeFormat($d->created_at)); ?></td>
                                <td>
                                    <?php if($d->status == 1): ?>
                                ...
                                <td class="text-end">
                                    <a href="<?php echo e(route($page.'.edit', $d->id)); ?>">
...
<!--end::Card--><?php /**PATH D:\hms_temp\resources\views/modules/departments/include/list_partial.blade.php ENDPATH**/ ?>