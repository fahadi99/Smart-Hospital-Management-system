                    ...
                    <table id="kt_project_users_table"
                        ...
                        <thead class="text-gray-500 fs-7 text-uppercase">
                            <tr role="row" class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <th class="text-gray-800 border-gray-200 min-w-90px fw-semibold fs-6 border-bottom"
                                    data-dt-column="0" rowspan="1" colspan="1" aria-label="Manager: Activate to sort"
                                    tabindex="0"><span class="dt-column-title" role="button">Patient Name</span><span
                                        class="dt-column-order"></span></th>
                                <th class="text-gray-800 border-gray-200 min-w-90px fw-semibold fs-6 border-bottom"
                                    data-dt-column="0" rowspan="1" colspan="1" aria-label="Manager: Activate to sort"
                                    tabindex="0"><span class="dt-column-title" role="button">Doctor Name</span><span
                                        class="dt-column-order"></span></th>
                                <th class="min-w-70px dt-orderable-asc dt-orderable-desc" data-dt-column="1" rowspan="1"
                                    colspan="1" aria-label="Date: Activate to sort" tabindex="0"><span
                                        class="dt-column-title" role="button">Date</span><span
                                        class="dt-column-order"></span></th>
                                
                                <th class="min-w-30px dt-orderable-asc dt-orderable-desc" data-dt-column="3" rowspan="1"
                        ...
                        <tbody class="fs-6">
                            ...
                            <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href=""
                                                class="mb-1 text-gray-800 text-hover-primary"><?php if(isset($d->patient_name)): ?>
                                ...
                                <td class="text-end">
                                    ...
                                    <a title="Download Prescription" target="_blank"
                                        href="<?php echo e(route($page.'.downlaod',$d->id)); ?>"><button
                                    ...
                                    <a title="Edit Prescription" href="<?php echo e(route($page.'.edit',$d->id)); ?>"><button
                                            class="btn btn-icon btn-active-light-primary w-30px h-30px me-3"
                                            data-bs-toggle="modal" data-bs-target="#kt_modal_update_permission">
                                    ...
                                    <a title="Delete Prescription" href="<?php echo e(route($page.'.delete', ['id' => $d->id])); ?>"
...
<!--end::Card--><?php /**PATH D:\hms_temp\resources\views/modules/prescriptions/include/list_partial.blade.php ENDPATH**/ ?>