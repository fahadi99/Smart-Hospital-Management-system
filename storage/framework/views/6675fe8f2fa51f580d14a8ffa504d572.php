    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack"
        ...
        <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
            ...
            <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <a href="<?php echo e(route('service_categories.index')); ?>">
                    <span></span>
                    <li class="breadcrumb-item text-muted text-hover-primary"><?php echo e($sc); ?></li>
                </a>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        ...
        <div class="gap-2 d-flex align-items-center gap-lg-3" data-select2-id="select2-data-122-cw9r">
            ...
            <a href="<?php echo e(route($page.'.create')); ?>">
                <button type="button" class="btn btn-sm btn-light-primary" data-bs-toggle="modal"
                    ...
                    </i>Add Service Category</button></a>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master',['activeMenu' => 'settings_management', 'activeSubMenu' => $page, 'activeThirdMenu' => $page], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\hms_temp\resources\views/modules/service_categories/index.blade.php ENDPATH**/ ?>