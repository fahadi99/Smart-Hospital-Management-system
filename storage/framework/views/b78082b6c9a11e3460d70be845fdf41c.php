                    ...
                    <table id="kt_project_users_table"
                        ...
                        <tbody class="fs-6">
                            ...
                            <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href="" class="mb-1 text-gray-800 text-hover-primary"><?php if(isset($d->name)): ?>
                                                <?php echo e($d->name); ?>
                                ...
                                <td class="dt-type-numeric"><?php if(isset($d->role_name)): ?>
                                    <?php echo e($d->role_name); ?>
                                ...
                                <td class="text-end">
                                    ...
                                    <a href="<?php echo e(route('users.edit',$d->id)); ?>"><button
...
<!--end::Card-->
<?php /**PATH D:\hms_temp\resources\views/modules/users/include/list_partial.blade.php ENDPATH**/ ?>