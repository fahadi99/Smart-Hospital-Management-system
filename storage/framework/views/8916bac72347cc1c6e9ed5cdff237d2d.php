...
<div class="py-4 border-0 card-header bgi-position-y-bottom bgi-position-x-end bgi-size-cover bgi-no-repeat rounded-0"
    ...
    style="background-image:url('<?php echo e(getAssetsURLs('media/misc/layout/customizer-header-bg.jpg')); ?>')">
    <!--begin::Card title-->
...
<div class="row " data-kt-buttons="true" data-kt-buttons-target=".form-check-image,.form-check-input">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success">
					...
					<div class="border-2 border-gray-200 form-check-wrapper">
						<img src="<?php echo e(getAssetsURLs('media/preview/light-ltr.png')); ?>" class="form-check-rounded mw-100" alt=""/>
					</div>
					<!--end::Image-->
					<!--begin::Check-->
					<div class="form-check form-check-custom form-check-solid form-check-sm form-check-success">
                        ...
                        <?php if($preferences['preference']['theme'] === "light"): ?>
                        checked
                        <?php endif; ?>
                        />
						<!--begin::Label-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success active">
					<!--begin::Image-->
					<div class="border-2 border-gray-200 form-check-wrapper">
						<img src="<?php echo e(getAssetsURLs('media/preview/dark-ltr.png')); ?>" class="form-check-rounded mw-100" alt=""/>
					</div>
					<!--end::Image-->
					<!--begin::Check-->
					<div class="form-check form-check-custom form-check-solid form-check-sm form-check-success">
						<input class="form-check-input"
                        type="radio" value="dark" name="theme"
                        <?php if($preferences['preference']['theme'] === "dark"): ?>
                        checked
                        <?php endif; ?>
                        />
						<!--begin::Label-->
...
<div class="form-group d-flex flex-stack">
	...
	<div class="d-flex justify-content-end">
		...
		<div class="form-check form-check-custom form-check-solid form-check-success form-switch">
			<input
            <?php if($preferences['preference']['rtl_mode'] === 0): ?>
            checked
            <?php endif; ?>
            type="hidden"
            value="false"
            name="rtl_mode"/>
			<input
            <?php if($preferences['preference']['rtl_mode'] === 1): ?>
            checked
            <?php endif; ?>
	...
	<!--begin::Col-->
			<div class="col-6">
				...
				<label class="form-check-image form-check-success active"  >
					<!--begin::Image-->
					<div class="border-2 border-gray-200 form-check-wrapper">
						<img src="<?php echo e(getAssetsURLs('media/preview/layouts/dark-sidebar.png')); ?>" class="form-check-rounded mw-100" alt=""/>
					</div>
					<!--end::Image-->
					<!--begin::Check-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success "  >
					<!--begin::Image-->
					<div class="border-2 border-gray-200 form-check-wrapper">
						<img src="<?php echo e(getAssetsURLs('media/preview/layouts/light-sidebar.png')); ?>" class="form-check-rounded mw-100" alt=""/>
					</div>
					<!--end::Image-->
					<!--begin::Check-->
					<div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success "  >
					<!--begin::Image-->
					<div class="border-2 border-gray-200 form-check-wrapper">
						<img src="<?php echo e(getAssetsURLs('media/preview/layouts/dark-header.png')); ?>" class="form-check-rounded mw-100" alt=""/>
					</div>
					<!--end::Image-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success "  >
					<!--begin::Image-->
					<div class="border-2 border-gray-200 form-check-wrapper">
						<img src="<?php echo e(getAssetsURLs('media/preview/layouts/light-header.png')); ?>" class="form-check-rounded mw-100" alt=""/>
					</div>
					<!--end::Image-->
	...
	<div class="row gy-3" data-kt-buttons="true" data-kt-buttons-target=".form-check-image:not(.disabled),.form-check-input:not([disabled])">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success active"  >
					...
					<div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
						<input
							class="form-check-input" type="radio"
                            <?php if($preferences['preference']['system_language'] === "english"): ?>
                            checked
                            <?php endif; ?>
							value="english"
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success">
					...
					<div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
						<input
                            <?php if($preferences['preference']['system_language'] === "arabic"): ?>
                            checked
                            <?php endif; ?>
							class="form-check-input" type="radio"
							value="arabic"
	...
	<div class="row gy-3" data-kt-buttons="true" data-kt-buttons-target=".form-check-image:not(.disabled),.form-check-input:not([disabled])">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success active"  >
					...
					<div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
						<input
							class="form-check-input" type="radio"
                            <?php if($preferences['preference']['data_view'] === "list"): ?>
                            checked
                            <?php endif; ?>
							value="list"
							name="data_view"/>
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success "  >
					...
					<div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
						<input
                            <?php if($preferences['preference']['data_view'] === "grid"): ?>
                            checked
                            <?php endif; ?>
							class="form-check-input" type="radio"
							value="grid"
...
<button type="button" type="submit" id="addLayoutOutOptions" class="btn btn-primary flex-grow-1 fw-semibold">Save</button>
...
<?php /**PATH D:\hms_temp\resources\views/layouts/include/layout_builder.blade.php ENDPATH**/ ?>