<div class="mb-5 form-group row bg-search">
    ...
    <div class="col-lg-7">
        <input type="text" id="q" name="user_name"
            class="mb-3 ajax_call_trigger form-control form-control-solid mb-lg-0" placeholder="Search Service Category"
...
</div><?php /**PATH D:\hms_temp\resources\views/modules/service_categories/include/search_partial.blade.php ENDPATH**/ ?>