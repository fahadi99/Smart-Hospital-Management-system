<div class="mb-5 form-group row bg-search">
    ...
    <div class="col-lg-3">
        <select id="status" class="form-select ajax_call_trigger form-select-solid " data-kt-select2="true"
            ...
            <option <?php echo e(!isset($search['status']) || $search['status']==2); ?> value="2">All</option>
            <option <?php echo e(isset($search['status']) && $search['status']==1); ?> value="1">Active</option>
            <option <?php echo e(isset($search['status']) && $search['status']==0); ?> value="0">Inactive</option>
        </select>
    </div>
...
</div><?php /**PATH D:\hms_temp\resources\views/modules/users/include/search_partial.blade.php ENDPATH**/ ?>