                        ...
                        <thead class="text-gray-500 fs-7 text-uppercase">
                            <tr role="row" class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <th class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom"
                                    ...
                                    tabindex="0"><span class="dt-column-title">Patients</span><span
                        ...
                        <tbody class="fs-6">
                            ...
                            <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="me-5 position-relative">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <?php if($d->image): ?>
                                                <img src="<?php echo e(AvatarImagePath($d->image)); ?>" alt="Pic">
                                                <?php endif; ?>
                                            </div>
                                            <!--end::Avatar-->
                                        </div>
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href=""
                                                class="mb-1 text-gray-800 text-hover-primary"><?php if(isset($d->name_of_patient)): ?>
                                                <?php echo e($d->name_of_patient); ?>
                                ...
                                <td class="text-end">
                                    ...
                                    <a title="Downlaod Visting Card" target="_blank"
...
<!--end::Card-->
<?php /**PATH D:\hms_temp\resources\views/modules/patients/include/list_partial.blade.php ENDPATH**/ ?>