                        ...
                        <thead class="text-gray-500 fs-7 text-uppercase">
                            <tr role="row" class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <th class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom"
                                    ...
                                    tabindex="0"><span class="dt-column-title" role="button">Receipt number</span><span
                        ...
                        <tbody class="fs-6">
                            ...
                            <tr class="text-gray-800 border-gray-200 fw-semibold fs-6 border-bottom">
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column justify-content-center">
                                            <a href=""
                                                class="mb-1 text-gray-800 text-hover-primary"><?php if(isset($d->receipt_number)): ?>
                                                <?php echo e($d->receipt_number); ?>
                                ...
                                <td class="text-end">
                                    ...
                                    <a title="Downlaod Receipt" target="_blank"
...
<!--end::Card--><?php /**PATH D:\hms_temp\resources\views/modules/invoices/include/list_partial.blade.php ENDPATH**/ ?>