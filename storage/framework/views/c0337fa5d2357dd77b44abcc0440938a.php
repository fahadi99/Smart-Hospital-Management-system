        ...
        <div class="gap-2 d-flex align-items-center gap-lg-3" data-select2-id="select2-data-122-cw9r">
            ...
            <a href="<?php echo e(route($page.'.create')); ?>">
                <button type="button" class="btn btn-sm btn-light-primary" data-bs-toggle="modal"
                    ...
                    </i>Generate Prescription Slip</button></a>
        </div>
...
'activeThirdMenu' => 'prescriptions'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\hms_temp\resources\views/modules/prescriptions/index.blade.php ENDPATH**/ ?>