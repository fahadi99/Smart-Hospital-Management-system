...
<div class="row " data-kt-buttons="true" data-kt-buttons-target=".form-check-image,.form-check-input">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success">
					...
					<div class="border-2 border-gray-200 form-check-wrapper">
						<img src="{{getAssetsURLs('media/preview/light-ltr.png')}}" class="form-check-rounded mw-100" alt=""/>
					</div>
					<!--end::Image-->
					<!--begin::Check-->
					<div class="form-check form-check-custom form-check-solid form-check-sm form-check-success">
                        ...
                        @if($preferences['preference']['theme'] === "light")
                        checked
                        @endif
                        />
						<!--begin::Label-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success active">
					<!--begin::Image-->
					<div class="border-2 border-gray-200 form-check-wrapper">
						<img src="{{getAssetsURLs('media/preview/dark-ltr.png')}}" class="form-check-rounded mw-100" alt=""/>
					</div>
					<!--end::Image-->
					<!--begin::Check-->
					<div class="form-check form-check-custom form-check-solid form-check-sm form-check-success">
                        ...
                        @if($preferences['preference']['theme'] === "dark")
                        checked
                        @endif
                        />
						<!--begin::Label-->
...
<div class="form-group d-flex flex-stack">
	...
	<div class="d-flex justify-content-end">
		...
		<div class="form-check form-check-custom form-check-solid form-check-success form-switch">
			<input
            @if($preferences['preference']['rtl_mode'] === 0)
            checked
            @endif
            type="hidden"
            value="false"
            name="rtl_mode"/>
			<input
            @if($preferences['preference']['rtl_mode'] === 1)
            checked
            @endif
	...
	<!--begin::Col-->
			<div class="col-6">
				...
				<label class="form-check-image form-check-success active"  >
					<!--begin::Image-->
					<div class="border-2 border-gray-200 form-check-wrapper">
						<img src="{{getAssetsURLs('media/preview/layouts/dark-sidebar.png')}}" class="form-check-rounded mw-100" alt=""/>
					</div>
					<!--end::Image-->
					<!--begin::Check-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success "  >
					<!--begin::Image-->
					<div class="border-2 border-gray-200 form-check-wrapper">
						<img src="{{getAssetsURLs('media/preview/layouts/light-sidebar.png')}}" class="form-check-rounded mw-100" alt=""/>
					</div>
					<!--end::Image-->
					<!--begin::Check-->
					<div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success "  >
					<!--begin::Image-->
					<div class="border-2 border-gray-200 form-check-wrapper">
						<img src="{{getAssetsURLs('media/preview/layouts/dark-header.png')}}" class="form-check-rounded mw-100" alt=""/>
					</div>
					<!--end::Image-->
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success "  >
					<!--begin::Image-->
					<div class="border-2 border-gray-200 form-check-wrapper">
						<img src="{{getAssetsURLs('media/preview/layouts/light-header.png')}}" class="form-check-rounded mw-100" alt=""/>
					</div>
					<!--end::Image-->
	...
	<div class="row gy-3" data-kt-buttons="true" data-kt-buttons-target=".form-check-image:not(.disabled),.form-check-input:not([disabled])">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success active"  >
					...
					<div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
						<input
							class="form-check-input" type="radio"
                            @if($preferences['preference']['system_language'] === "english")
                            checked
                            @endif
							value="english"
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success">
					...
					<div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
						<input
                            @if($preferences['preference']['system_language'] === "arabic")
                            checked
                            @endif
							class="form-check-input" type="radio"
							value="arabic"
	...
	<div class="row gy-3" data-kt-buttons="true" data-kt-buttons-target=".form-check-image:not(.disabled),.form-check-input:not([disabled])">
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success active"  >
					...
					<div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
						<input
							class="form-check-input" type="radio"
                            @if($preferences['preference']['data_view'] === "list")
                            checked
                            @endif
							value="list"
							name="data_view"/>
			...
			<div class="col-6">
				...
				<label class="form-check-image form-check-success "  >
					...
					<div class="form-check form-check-custom form-check-success form-check-sm form-check-solid">
						<input
                            @if($preferences['preference']['data_view'] === "grid")
                            checked
                            @endif
							class="form-check-input" type="radio"
							value="grid"
