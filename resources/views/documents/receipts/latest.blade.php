...
<body>
    <div class="container">
        <!-- Header Section -->
        <div class="header">
            <img src="{{'data:image/png;base64,'.base64_encode(file_get_contents(public_path('logo.jpg')))}}" width="250px" alt="" style="margin-bottom: -100px !important">
            <div class="title">
            ...
            <img src="{{'data:image/png;base64,'.base64_encode(file_get_contents(public_path('samrtcitylogo.png')))}}" alt="" style="margin-left : 600px !important;  margin-top : -160px !important">
        </div>
        ...
        <div class="totals">
            ...
            @if ($obj->discount_amount > 0)
            <div  style="margin-right: 100px !importantt"> Net Amount: &nbsp;&nbsp; &nbsp;&nbsp; {{$obj->net_amount}}</div>
            @else
            ...
            @if ($obj->discount_amount > 0)
            <div style="margin-right: 100px !importantt">Amount Received: &nbsp;&nbsp; &nbsp;&nbsp;  {{$obj->amount_received}}</div>
            @else
