                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="service_name" class="form-control"
                                value="{{ old('service_name') }}" placeholder="Enter full service name" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="number" name="default_amount" class="form-control"
                                value="{{ old('default_amount') }}" placeholder="Enter default amount" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="number" name="employee_amount" class="form-control"
                                value="{{ old('employee_amount') }}" placeholder="Enter employee amount" />
                            {{-- <span class="form-text text-muted">We'll never share your email with anyone else</span>
                            --}}
                            <div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="number" name="resident_amount" class="form-control"
                                value="{{ old('resident_amount') }}" placeholder="Enter resident amount" />
                            {{-- <span class="form-text text-muted">We'll never share your email with anyone else</span>
                            --}}
                            <div>
