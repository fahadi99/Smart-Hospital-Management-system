        ...
        <form class="form" action="{{route($page.'.update',$obj->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="mb-15">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="service_name" class="form-control"
                                placeholder="Enter full service name" value="{{$obj->service_name}}" />
                    ...
                    <br>
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Default Amount:</label>
                        <div class="col-lg-6">
                            <input type="number" name="default_amount" class="form-control"
                                placeholder="Enter default amount" value="{{$obj->default_amount}}" />
                    ...
                    <br>
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Employee Amount:</label>
                        <div class="col-lg-6">
                            <input type="number" name="employee_amount" class="form-control"
                                placeholder="Enter employee amount" value="{{$obj->employee_amount}}" />
                            {{-- <span class="form-text text-muted">We'll never share your email with anyone else</span>
                            --}}
                            <div>
                    ...
                    <br>
                    <div class="form-group row">
                        <label class="text-right col-lg-3 col-form-label">Resident Amount:</label>
                        <div class="col-lg-6">
                            <input type="number" name="resident_amount" class="form-control"
                                placeholder="Enter resident amount" value="{{$obj->resident_amount}}" />
                            {{-- <span class="form-text text-muted">We'll never share your email with anyone else</span>
                            --}}
                            <div>
