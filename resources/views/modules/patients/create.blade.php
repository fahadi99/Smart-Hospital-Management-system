                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="name_of_patient" pattern="[A-Za-z\s]+" class="form-control"
                                value="{{ old('name_of_patient') }}" placeholder="Enter patient full name" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="number" name="cnic_number" class="form-control"
                                value="{{ old('cnic_number') }}" placeholder="Enter CNIC" maxlength="13" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="date" name="date_of_birth" class="form-control" max="{{ date('Y-m-d') }}"
                                value="{{ old('date_of_birth') }}" placeholder="Enter dob" />
                            {{-- <span class="form-text text-muted">We'll never share your email with anyone else</span>
                            --}}
                            <div>
                                @error('date_of_birth')
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="reffering_doctor_name" class="form-control"
                                value="{{ old('reffering_doctor_name') }}" placeholder="Enter reffering doctor name" />
                            {{-- <span class="form-text text-muted">We'll never share your phone with anyone else</span>
                            --}}
                            <div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control" name="patient_category" data-live-search="true"
                                ...
                                <option value="resident" {{ "resident"===old('patient_category') ? 'selected' : '' }}>
                                    Resident </option>
                                <option value="non_resident" {{ "non_resident"===old('patient_category') ? 'selected'
                                    : '' }}> Non Resident </option>
                                <option value="employee" {{ "employee"===old('patient_category') ? 'selected' : '' }}>
                                    Employee </option>
                            </select>
                            <div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <select class="form-control" name="gender" data-live-search="true" id="deviceSelect">
                                ...
                                <option value="female" {{ "female"===old('gender') ? 'selected' : '' }}> Female
                                </option>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="emergency_contact_name" class="form-control"
                                placeholder="Enter emergency contact name" value="{{ old('emergency_contact_name') }}"
                                required />
                        </div>
                    </div>
                    <br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input type="text" name="emergency_contact_relation" class="form-control"
                                placeholder="Enter relation" value="{{ old('emergency_contact_relation') }}" required />
                        </div>
                    </div>
                    <br>
